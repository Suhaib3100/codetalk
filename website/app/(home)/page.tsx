  ...
  return (
    ...
    >
      ...
      <h2 className="bg-gradient-to-b from-foreground to-foreground/40 bg-clip-text text-center text-2xl font-semibold text-transparent md:text-4xl">
        Build code documentation 100x faster and easier
        <p className="max-md:hidden">with Codetalk</p>
      </h2>
      <p className="mt-4 text-center text-foreground/50">
        Codetalk offers a complete toolchain to build and maintain your code documentation.
      </p>
      <WhyInteractive
        typeTable={
          <AutoTypeTable
    ...
    './content/**/*.mdx',
        ...
        codeblockInteractive={
          <CodeBlock
            ...
            code={`
              ✨ Welcome to CodeTalk!
An AI-powered CLI tool for intelligent code commenting.
...
│           │       │ src\processor.js... │
└───────────┴───────┴─────────────────────┘
? What would you like to comment? All files
? What type of commenting do you prefer? Basic - Essential function and class documentation   
⠦ Adding comments to your code...Invalid response from AI - skipping file
✔ Successfully added comments to your code!
...
Created by Suhaib King
GitHub: https://github.com/Suhaib3100/codetalk
              `}
          />
        }
        codeblockMdx={
    ...
    <div className="grid grid-cols-1 border-b border-r md:grid-cols-2 lg:grid-cols-3">
      <div className="relative flex flex-col gap-8 overflow-hidden border-l border-t px-8 py-14">
        ...
        <div className="flex flex-row flex-wrap gap-2 border-t pt-8">
          ...
          <a
            href="https://githubbox.com/suhaib3100/codetalk"
  ...
  return (
    <div className="container relative z-[2] flex flex-col overflow-hidden border-x border-t bg-fd-background px-6 pt-12 max-md:text-center md:px-12 md:pt-16 [.uwu_&]:hidden">
      ...
      <h1 className="mb-8 max-w-[600px] text-4xl font-medium max-md:hidden">
        Build excellent documentation in your code environme
      </h1>
...
╔════════════════════════════════════════╗
║                                        ║
║   CodeTalk - AI Code Commenting Tool   ║
║                                        ║
╚════════════════════════════════════════╝
   ---        
  ...
  return (
    <div className="flex flex-col items-center border-x border-t px-4 py-16 text-center">
      ...
      <p className="mb-4 text-fd-muted-foreground">
        Codetalk is 100% powered by passion and open source community.
      </p>
      <div className="mb-8 flex flex-row items-center gap-2">
        ...
        <a
          href="https://github.com/Suhaib3100/codetalk/graphs/contributors"
          rel="noreferrer noopener"
      ...
      <ContributorCounter repoOwner="Suhaib3100" repoName="codetalk" />
    </div>
  );
}
...
function Features(): React.ReactElement {
  return (
    <div className="grid grid-cols-1 border-r md:grid-cols-2">
      <Feature
        icon={PaperclipIcon}
        subheading="AI-Powered"
        heading="Intelligent Code Commenting"
        description={
          <>
            <span className="font-medium text-foreground">
              Codetalk uses AI to generate meaningful comments for your code, making it easier to understand and maintain.
            </span>
          </>
        }
        ...
        <div className="mt-8 flex flex-col">
          ...
          <div className="z-[2] mt-[-150px] w-[300px] overflow-hidden rounded-lg border border-fd-foreground/10 shadow-xl backdrop-blur-lg">
            ...
            <pre className="p-4 text-[13px]">
              <code className="grid">
                <span className="font-medium"># AI-Powered Commenting</span>
                <span>Codetalk generates comments for your code.</span>
                <span>{` `}</span>
                <span className="font-medium">{`<CommentedCode />`}</span>
              </code>
            </pre>
          </div>
        </div>
      ...
      <Feature
        icon={SearchIcon}
        subheading="Easy Installation"
        heading="Get Started Quickly"
        description="Install Codetalk with a single command and start commenting your code."
      >
        <Link
      ...
      <Feature
        icon={Terminal}
        subheading="Interactive CLI"
        heading="User-Friendly Experience"
        description="Codetalk provides an interactive command-line interface that guides you through the commenting process."
      >
        <CodeBlock
          code="npx codetalk"
          lang="bash"
        ...
        <pre className="grid grid-cols-1 rounded-lg border bg-card p-4 text-xs leading-loose">
          <code>Launching Codetalk...</code>
          <code className="text-muted-foreground">{`-> Select files to comment`}</code>
          <code className="text-green-500">Ready to go!</code>
        </pre>
      </Feature>
      <Feature
        icon={CpuIcon}
        subheading="Flexible Commenting Styles"
        heading="Choose Your Style"
        description="Select between basic and advanced commenting styles to suit your needs."
      >
        <div className="mt-8 flex flex-col gap-4">
          ...
          >
            <div className="rounded-[inherit] bg-fd-background bg-gradient-to-br from-transparent via-fd-primary/10 p-4 transition-colors hover:bg-fd-muted">
              <LayoutIcon />
              <h3 className="font-semibold">Basic Comments</h3>
              <p className="text-sm text-fd-muted-foreground">
                Essential function and class documentation.
              </p>
            </div>
          </Link>
          <Link
          ...
          >
            <LibraryIcon />
            <h3 className="font-semibold">Advanced Comments</h3>
            <p className="text-sm text-fd-muted-foreground">
